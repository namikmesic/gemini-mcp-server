...
// Types for the SDK request options
...
// Interface defining the expected parameters and response
 ...
 */
export async function callGeminiApi(params: GeminiApiParams): Promise<GeminiApiResponse> {
  ...
  try {
    ...
    throw new ExternalApiError(
      'Could not parse Gemini response - missing text content', 
      200, 
    ...
    throw new ExternalApiError(
      error.message || 'Unknown error occurred calling Gemini API', 
      500, 
      error.stack
    );
  }
